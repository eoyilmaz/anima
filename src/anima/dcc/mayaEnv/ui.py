...
class PrevisUI(object):
    ...
    def init_ui(self):
        ...
        # the layout
        main_formLayout = core.formLayout("main_formLayout", nd=100, parent=self.window)
        ...
        lenght_slider_grp = core.intSliderGrp(
            field=True, cw2=(30, 70), cc=self.set_handle, min=0, v=15, max=50
        )
    ...
    def export(self, button_value):
        ...
        if self.mxf_checkBox.value():
            ...
            core.progressWindow(
                title="Converting To MXFs", progress=0, status="", isInterruptable=True
            )
