...
class oyBallisticRuler(OpenMayaMPx.MPxNode):
    ...
    def compute(self, plug, data):
        ...
        if plug == oyBallisticRuler.aTPos:
            ...
            vy = (
                endPos[1] - startPos[1]
            ) / frameInterval_asFloat + 0.5 * gravity_prime * frameInterval_asFloat
            ...
            for i in range(frameInterval + 1):
                ...
                tPosY = (
                    startPos[1]
                    + vy * i_asFloat
                    - 0.5 * gravity_prime * i_asFloat * i_asFloat
                )
...
def nodeInitializer():
    ...
    # ----------------
    # startPosX
    oyBallisticRuler.aStartPosX = nAttr.create(
        "startPosX", "spx", OpenMaya.MFnNumericData.kFloat
    )
    nAttr.setKeyable(True)
    oyBallisticRuler.addAttribute(oyBallisticRuler.aStartPosX)

    # startPosY
    oyBallisticRuler.aStartPosY = nAttr.create(
        "startPosY", "spy", OpenMaya.MFnNumericData.kFloat
    )
    nAttr.setKeyable(True)
    oyBallisticRuler.addAttribute(oyBallisticRuler.aStartPosY)

    # startPosZ
    oyBallisticRuler.aStartPosZ = nAttr.create(
        "startPosZ", "spz", OpenMaya.MFnNumericData.kFloat
    )
    nAttr.setKeyable(True)
    oyBallisticRuler.addAttribute(oyBallisticRuler.aStartPosZ)

    # startPos
    oyBallisticRuler.aStartPos = nAttr.create(
        "startPos",
        "sp",
        oyBallisticRuler.aStartPosX,
        oyBallisticRuler.aStartPosY,
        oyBallisticRuler.aStartPosZ,
    )
    nAttr.setKeyable(True)
    ...
    # ----------------
    # endPosX
    oyBallisticRuler.aEndPosX = nAttr.create(
        "endPosX", "epx", OpenMaya.MFnNumericData.kFloat
    )
    nAttr.setKeyable(True)
    oyBallisticRuler.addAttribute(oyBallisticRuler.aEndPosX)

    # endPosY
    oyBallisticRuler.aEndPosY = nAttr.create(
        "endPosY", "epy", OpenMaya.MFnNumericData.kFloat
    )
    nAttr.setKeyable(True)
    oyBallisticRuler.addAttribute(oyBallisticRuler.aEndPosY)

    # endPosZ
    oyBallisticRuler.aEndPosZ = nAttr.create(
        "endPosZ", "epz", OpenMaya.MFnNumericData.kFloat
    )
    nAttr.setKeyable(True)
    oyBallisticRuler.addAttribute(oyBallisticRuler.aEndPosZ)

    # endPos
    oyBallisticRuler.aEndPos = nAttr.create(
        "endPos",
        "ep",
        oyBallisticRuler.aEndPosX,
        oyBallisticRuler.aEndPosY,
        oyBallisticRuler.aEndPosZ,
    )
    nAttr.setKeyable(True)
    ...
    # ----------------
    # frameInterval
    oyBallisticRuler.aFrameInterval = nAttr.create(
        "frameInterval", "fi", OpenMaya.MFnNumericData.kInt
    )
    nAttr.setKeyable(True)
    nAttr.setMin(1)
    nAttr.setDefault(1)
    ...
    # ----------------
    # velocityVectorX
    oyBallisticRuler.aVelocityVectorX = nAttr.create(
        "velocityVectorX", "vvx", OpenMaya.MFnNumericData.kFloat
    )
    nAttr.setKeyable(True)
    oyBallisticRuler.addAttribute(oyBallisticRuler.aVelocityVectorX)

    # velocityVectorY
    oyBallisticRuler.aVelocityVectorY = nAttr.create(
        "velocityVectorY", "vvy", OpenMaya.MFnNumericData.kFloat
    )
    nAttr.setKeyable(True)
    oyBallisticRuler.addAttribute(oyBallisticRuler.aVelocityVectorY)

    # velocityVectorZ
    oyBallisticRuler.aVelocityVectorZ = nAttr.create(
        "velocityVectorZ", "vvz", OpenMaya.MFnNumericData.kFloat
    )
    nAttr.setKeyable(True)
    oyBallisticRuler.addAttribute(oyBallisticRuler.aVelocityVectorZ)

    # velocityVector
    oyBallisticRuler.aVelocityVector = nAttr.create(
        "velocityVector",
        "vv",
        oyBallisticRuler.aVelocityVectorX,
        oyBallisticRuler.aVelocityVectorY,
        oyBallisticRuler.aVelocityVectorZ,
    )
    nAttr.setKeyable(True)
    ...
    # ----------------
    # speed
    oyBallisticRuler.aSpeed = nAttr.create(
        "speed", "spd", OpenMaya.MFnNumericData.kFloat
    )
    nAttr.setKeyable(True)
    ...
    # ----------------
    # gravity
    oyBallisticRuler.aGravity = nAttr.create(
        "gravity", "g", OpenMaya.MFnNumericData.kFloat
    )
    nAttr.setKeyable(True)
    ...
    # ----------------
    # frameRate
    oyBallisticRuler.aFrameRate = nAttr.create(
        "frameRate", "fr", OpenMaya.MFnNumericData.kFloat
    )
    nAttr.setKeyable(True)
    ...
    oyBallisticRuler.aTPos = tAttr.create(
        "trajectoryPosition",
        "tp",
    ...
    # set effects
    oyBallisticRuler.attributeAffects(
        oyBallisticRuler.aStartPos, oyBallisticRuler.aTPos
    )
    oyBallisticRuler.attributeAffects(oyBallisticRuler.aEndPos, oyBallisticRuler.aTPos)
    oyBallisticRuler.attributeAffects(
        oyBallisticRuler.aFrameInterval, oyBallisticRuler.aTPos
    )
    oyBallisticRuler.attributeAffects(
        oyBallisticRuler.aVelocityVector, oyBallisticRuler.aTPos
    )
    ...
    oyBallisticRuler.attributeAffects(
        oyBallisticRuler.aFrameRate, oyBallisticRuler.aTPos
    )
