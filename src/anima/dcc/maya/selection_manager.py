...
class SelectionSet(object):
    ...
    Ex::
      ...
      from anima.dcc.maya import selection_manager
    ...
    def save(self):
        ...
        if self.__stored_selection_list__:
            self.__selection_set__ = pm.sets(
                self.__stored_selection_list__, name=self.name
            )
        else:
...
class SelectionRow(object):
    ...
    def _draw(self):
        ...
        grid_layout_width = pm.gridLayout(
            "selectionManager_gridLayout1", q=True, w=True
        )
        form_layout = pm.formLayout(
            p="selectionManager_gridLayout1", w=grid_layout_width, nd=100
        )
        with form_layout:
            ...
            self.del_button = pm.button(ann="Deletes this button set", l="D", w=17)
        ...
        self.layout = pm.formLayout(
            ...
            edit=True,
            attachForm=[
                (self.replace_button, "left", 0),
                (self.replace_button, "top", 0),
                (self.replace_button, "bottom", 0),
                (self.add_button, "top", 0),
                (self.add_button, "bottom", 0),
                (self.subtract_button, "top", 0),
                (self.subtract_button, "bottom", 0),
                (self.and_button, "top", 0),
                (self.and_button, "bottom", 0),
                (self.or_button, "top", 0),
                (self.or_button, "bottom", 0),
                (self.save_button, "top", 0),
                (self.save_button, "bottom", 0),
                (self.update_button, "top", 0),
                (self.update_button, "bottom", 0),
                (self.del_button, "top", 0),
                (self.del_button, "bottom", 0),
                (self.description_field, "top", 0),
                (self.description_field, "bottom", 0),
    ...
    def save_button_callback(self):
        self.selection_set.__name__ = pm.textField(
            self.description_field, q=True, tx=True
        )
