...
env_paths = [
    ...
    # "../../../maya",
    "../../../maya/config",
    f"../../../maya/config/{maya_version}",
    "../../../maya/plugins",
    f"../../../maya/plugins/{maya_version}",
]
...
if not pm.general.about(batch=1):
    ...
    def create_menus():
        ...
        pm.menuItem(
            label="Toolbox", c="from anima.dcc.maya import toolbox; toolbox.UI();"
        )
    ...
    def load_arnold():
        try:
            ...
            if pymel.versions.current() >= 201700:
                from anima.dcc.maya.config import arnold_patches
...
pm.evalDeferred("from anima.dcc.maya.common import Maya; Maya.clean_malware();")
