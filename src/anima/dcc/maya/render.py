...
class Render(object):
    ...
    def vertigo_setup_look_at(cls):
        ...
        selected camera
        """
        from anima.dcc.maya import vertigo
    ...
    def afanasy_job_submitter(cls):
        ...
        from anima.dcc.maya import afanasy
    ...
    def auto_convert_to_redshift(cls):
        ...
        from anima.dcc.maya import ai2rs
    ...
    def generate_reflection_curve(self):
        ...
        panel = anima.dcc.maya.playblast.Playblaster.get_active_panel()
...
class LightingSceneBuilder(object):
    ...
    def build(
        ...
        :return:
        """
        from anima.dcc import maya

        # get the current version
        m = anima.dcc.maya.common.Maya()
        v = m.get_current_version()
        if not v:
            raise RuntimeError(
        ...
        for cache_ref_node in pm.listReferences():
            ...
            if transfer_uvs and cache_root_nodes:
                from anima.dcc.maya import modeling
