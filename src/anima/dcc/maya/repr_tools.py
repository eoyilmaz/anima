...
import anima.dcc.maya.playblast
...
class RepresentationGenerator(object):
    ...
    def generate_ass(self):
        ...
        active_panel = anima.dcc.maya.playblast.Playblaster.get_active_panel()
    ...
    def generate_rs(self):
        ...
        # from anima.dcc.maya.redshift import RedShiftTextureProcessor
