            ...
            for clip in all_clips:
                ...
                for shot in shots:
                    if clip.id.lower() == shot.full_shot_name.lower():
                        ...
                        # print('-------------------------------')
                        # print('clip.in     : {}'.format(clip.in_))
                        # print('clip.out    : {}'.format(clip.out))
                        # print('clip.start  : {}'.format(clip.start))
                        # print('clip.end    : {}'.format(clip.end))
...
class SequencerExtension(object):
    ...
    def metafuze(self):
        ...
        for i, xml in enumerate(xmls):
            ...
            # print("xml path: {}".format(temp_file_path))
...
class ShotExtension(object):
    ...
    def playblast(self, options=None):
        ...
        from anima.dcc.maya.playblast import Playblaster
