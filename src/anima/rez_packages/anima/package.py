...
def commands():
    ...
    if "maya" in this.root:
        ...
        env.PATH.append("{}/bin".format(pylibs_base_path))
        env.PYTHONPATH.append("{}/lib/python/site-packages".format(pylibs_base_path))
        env.PYTHONPATH.append("${ANIMA_PATH}/anima/dcc/maya/config")
        env.PYTHONPATH.append(
            "${ANIMA_PATH}/anima/dcc/maya/config/${REZ_MAYA_MAJOR_VERSION}"
        )
        env.PYTHONPATH.append("${ANIMA_DEV_PATH}/maya/scripts")

        # MAYA_SCRIPT_PATH
        env.MAYA_SCRIPT_PATH.append("${ANIMA_PATH}/anima/dcc/maya/config")
        env.MAYA_SCRIPT_PATH.append(
            "${ANIMA_PATH}/anima/dcc/maya/config/${REZ_MAYA_MAJOR_VERSION}"
        )

        env.MAYA_PLUG_IN_PATH.append("${ANIMA_PATH}/anima/dcc/maya/plugins")
        ...
        env.MAYA_PLUG_IN_PATH.append(
            "${ANIMA_PATH}/anima/dcc/maya/plugins/${REZ_MAYA_MAJOR_VERSION}"
        )
