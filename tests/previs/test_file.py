...
class FileTestCase(unittest.TestCase):
    ...
    def test_pathurl_argument_is_skipped(self):
        """default value will be used when the pathurl argument is
        skipped
        """
        f = File()
    ...
    def test_pathurl_argument_is_not_a_string(self):
        """a TypeError will be raised when the pathurl argument is not
        a string instance
        """
    ...
    def test_pathurl_attribute_is_not_a_string(self):
        """a TypeError will be raised when the pathurl attribute is set
    ...
    def test_pathurl_argument_is_working_properly(self):
        """pathurl argument value is correctly passed to the
        pathurl
        attribute
        """
    ...
    def test_pathurl_will_set_the_id_attribute(self):
        """setting the pathurl attribute will also set the id
        attribute
        """
        f = File()
    ...
    def test_pathurl_attribute_is_working_properly(self):
        """pathurl attribute value can be correctly changed"""
        f = File(pathurl="shot1")
        test_value = "shot2"
  ...
  <pathurl>file://localhost/home/eoyilmaz/maya/projects/default/data/shot2.mov</pathurl>
    ...
    def test_id_is_generated_from_pathurl(self):
        """id attribute is generated from pathurl and it is
    ...
    def test_id_after_a_second_call_to_to_xml_will_change_id_id(self):
        """id attribute will be changed to an element with just
        id attribute
        """
        f = File(
            pathurl="file://localhost/S:/KKS/Sequences/SEQ001/001A_TNGE/Shots"
        ...
        self.assertEqual(call2, f'<file id="{f.id}"/>')
