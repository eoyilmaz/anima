...
class SequenceManagerTestCase(unittest.TestCase):
    ...
    def test_from_xml_path_argument_skipped(self):
        ...
        self.assertEqual(
            cm.exception.message, "from_xml() takes exactly 2 arguments (1 given)"
        )
    ...
    def test_from_xml_path_argument_is_not_a_valid_path(self):
        ...
        self.assertEqual(
            cm.exception.message, "Please supply a valid path to an XML file!"
        )
    ...
    def test_from_xml_generates_correct_sequencer_hierarchy(self):
        ...
        self.assertEqual("/tmp/SEQ001_HSNI_003_0010_v001.mov", shot1.output.get())
        ...
        self.assertEqual("/tmp/SEQ001_HSNI_003_0020_v001.mov", shot2.output.get())
        ...
        self.assertEqual("/tmp/SEQ001_HSNI_003_0030_v001.mov", shot3.output.get())
    ...
    def test_from_edl_updates_sequencer_hierarchy_with_shots_used_more_than_one_times(
        ...
        self.assertEqual(shot3.get_camera(), shot4.get_camera())
    ...
    def test_create_sequence_is_properly_setting_the_sequence_name(self):
        ...
        self.assertEqual("Test Sequence", seq.sequence_name.get())
    ...
    def test_to_edl_is_working_properly(self):
        ...
        l = self.sm.to_edl()
        self.assertIsInstance(l, edl.List)
    ...
    def test_to_edl_generates_a_proper_edl_content(self):
        ...
        self.assertEqual(expected_edl_content, result)
    ...
    def test_generate_sequence_structure_is_working_properly(self):
        ...
        self.assertEqual(
            "file://localhost/tmp/SEQ001_HSNI_003_0010_v001.mov", file1.pathurl
        )
        ...
        self.assertEqual(
            "file://localhost/tmp/SEQ001_HSNI_003_0020_v001.mov", file2.pathurl
        )
        ...
        self.assertEqual(
            "file://localhost/tmp/SEQ001_HSNI_003_0030_v001.mov", file3.pathurl
        )
