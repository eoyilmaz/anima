...
class ClipTestCase(unittest.TestCase):
    ...
    def test_id_argument_is_skipped(self):
        """default value will be used when the id argument is
        skipped
        """
        c = Clip()
    ...
    def test_id_argument_is_not_a_string(self):
        """a TypeError will be raised when the id argument is not
        a string instance
        """
        ...
        self.assertEqual(
            cm.exception.message, "Clip.id should be a string or unicode, not int"
        )

    def test_id_attribute_is_not_a_string(self):
        """a TypeError will be raised when the id attribute is set
    ...
    def test_id_argument_is_working_properly(self):
        """id argument value is correctly passed to the id
        attribute
        """
        c = Clip(id="shot2")
    ...
    def test_id_attribute_is_working_properly(self):
        """id attribute value can be correctly changed"""
        c = Clip(id="shot1")
        test_value = "shot2"
    ...
    def test_to_xml_method_is_working_properly(self):
        ...
        expected_xml = """<clipitem id="shot2">
  <end>35</end>
  <name>shot2</name>
  ...
  <file id="shot2.mov">
    ...
    def test_rate_argument_is_skipped(self):
        """rate attribute value will be a Rate instance with
    ...
    def test_rate_argument_is_None(self):
        """rate attribute will be None if the rate argument is
        None
        """
        c = Clip(rate=None)
        rate = c.rate
    ...
    def tst_rate_attribute_is_None(self):
        """rate attribute can be set to None"""
    ...
    def test_rate_attribute_is_None_to_xml_is_working_properly(self):
        """rate attribute will not be included int the xml
  ...
  <file id="shot2.mov">
    ...
    def test_rate_attribute_is_valid_to_xml_is_working_properly(self):
        """rate attribute will be included int the xml output if
        it is not None
        """
        f = File()
        f.duration = 34
  ...
  <file id="shot2.mov">
    ...
    #     """setting the in smaller than out will convert the in to
    #     a negative value
    #     """
    #     c = Clip()
    #     c.in_ = 2073577
