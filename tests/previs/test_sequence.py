...
<sequence>
  ...
  <media>
    ...
    def test_to_edl_will_raise_RuntimeError_if_no_Media_instance_presents(self):
        """a RuntimeError will be raised when there is no Media
    ...
    def test_to_edl_method_will_return_a_List_instance(self):
        """to_edl method will return an edl.List instance"""
        s = Sequence()
        m = Media()
        s.media = m
    ...
    def test_to_edl_method_is_working_properly(self):
        """to_edl method will output a proper edl.List object"""
        ...
        self.assertEqual(
            "* SOURCE FILE: /tmp/SEQ001_HSNI_003_0020_v001.mov", e2.comments[1]
        )
        ...
        self.assertEqual(
            "* SOURCE FILE: /tmp/SEQ001_HSNI_003_0030_v001.mov", e3.comments[1]
        )

    def test_from_edl_method_is_working_properly(self):
        """from_edl method will return an anima.previs.Sequence
        ...
        self.assertEqual(
            "file://localhost/tmp/SEQ001_HSNI_003_0010_v001.mov", f.pathurl
        )
        ...
        self.assertEqual(
            "file://localhost/tmp/SEQ001_HSNI_003_0020_v001.mov", f.pathurl
        )
        ...
        self.assertEqual(
            "file://localhost/tmp/SEQ001_HSNI_003_0030_v001.mov", f.pathurl
        )
    ...
    def test_to_metafuze_xml_is_working_properly(self):
        """to_metafuze_xml method is working properly"""
        s = Sequence()
        s.duration = 109
