...
import unittest
import shutil
from anima.dcc import discover_env_vars
...
class EnvironmentVariableSetupTestCase(unittest.TestCase):
    """tests the anima.dcc.discover_env_variables() function
    """
    ...
    def test_env_variables_defined_with_asterix_will_defined_unrelated_to_the_env_name_argument(self):
        ...
        name will be defined no matter what is given for the dcc_name argument
        """
        os.environ['ENV1'] = '/Test/Value'
