...
from stalker import db, User, Repository, Status, FilenameTemplate, Structure, \
    StatusList, ImageFormat, Project, Type, Task, Asset, Sequence, Shot
...
def create_test_data(create_maya_test_db, create_pymel, create_maya_env):
    ...
    data["structure"] = Structure(
        ...
        templates=[data["task_template"], data["asset_template"],
                   data["shot_template"], data["sequence_template"]]
    )
    ...
    data["shot2"] = Shot(
        code='SH002',
        parent=data["sequence1"]
    )

    # create a child Shot (child of a child Sequence)
    data["shot3"] = Shot(
        code='SH003',
        parent=data["sequence2"]
    )

    data["shot3_anim"] = Task(
        name="Anim",
        type=data["anim_type"],
        parent=data["shot3"]
    )
    ...
    data["building1_props"] = Task(
        name='Props',
        parent=data["building1"]
    )

    data["building1_yapi"] = Task(
        name='YAPI',
    ...
    data["building1_yapi_model_proxy"] = Task(
        name='Proxy',
        type=data["model_type"],
        parent=data["building1_yapi_model"]
    )
    ...
    data["building1_layout_proxy"].depends.append(
        data["building1_yapi_model_proxy"]
    )

    data["building1_layout_hires"].depends.append(
    ...
    data["building2_props"] = Task(
        name='Props',
        parent=data["building2"]
    )

    data["building2_yapi"] = Task(
        name='YAPI',
    ...
    data["building2_yapi_model_proxy"] = Task(
        name='Proxy',
        type=data["model_type"],
        parent=data["building2_yapi_model"]
    )
    ...
    data["building2_layout_proxy"].depends.append(
        data["building2_yapi_model_proxy"]
    )

    data["building2_layout_hires"].depends.append(
    ...
    data["ext1_vegetation"] = Task(
        name='Vegetation',
        parent=data["ext1"],
        type=data["vegetation_type"]
    )

    # commit everything
    DBSession.add_all([
        data["repo1"], data["status_new"], data["status_wip"], data["status_comp"],
        data["project_status_list"], data["project"], data["task_status_list"],
        data["asset_status_list"], data["shot_status_list"],
        data["sequence_status_list"], data["task1"], data["task2"], data["task3"],
        data["task4"], data["task5"], data["task6"], data["asset1"], data["asset2"],
        data["shot1"], data["shot2"], data["shot3"], data["sequence1"], data["sequence2"],
        data["task_template"], data["asset_template"], data["shot_template"],
        data["sequence_template"],

        data["character_design_type"], data["model_type"],
        data["look_development_type"], data["rig_type"], data["exterior_type"],
        data["building_type"], data["layout_type"], data["prop_type"],
        data["vegetation_type"], data["assets"], data["characters"], data["char1"],
        data["character_design"], data["char1_model"], data["char1_look_dev"],
        data["char1_rig"], data["environments"], data["exteriors"], data["ext1"],

        data["building1"], data["building1_layout"], data["building1_layout_proxy"],
        data["building1_layout_hires"], data["building1_look_dev"],
        data["building1_props"], data["building1_yapi"],
        data["building1_yapi_model"], data["building1_yapi_model_proxy"],
        data["building1_yapi_model_hires"], data["building1_yapi_look_dev"],

        data["building2"], data["building2_layout"], data["building2_layout_proxy"],
        data["building2_layout_hires"], data["building2_look_dev"],
        data["building2_props"], data["building2_yapi"],
        data["building2_yapi_model"], data["building2_yapi_model_proxy"],
        data["building2_yapi_model_hires"], data["building2_yapi_look_dev"],

        data["ext1_layout"], data["ext1_layout_proxy"], data["ext1_layout_hires"],
        data["ext1_look_dev"], data["ext1_props"], data["prop1"], data["prop1_model"],
        data["prop1_model_proxy"], data["prop1_model_hires"],
        data["prop1_look_dev"], data["ext1_vegetation"]
    ])
    DBSession.commit()
    ...
    # asset2 lookdev
    data["asset2_lookdev_main_version1"] = create_version(data["asset2_lookdev"], 'Main')
    data["asset2_lookdev_main_version2"] = create_version(data["asset2_lookdev"], 'Main')
    data["asset2_lookdev_main_version3"] = create_version(data["asset2_lookdev"], 'Main')

    data["asset2_lookdev_take1_version1"] = create_version(data["asset2_lookdev"], 'Take1')
    data["asset2_lookdev_take1_version2"] = create_version(data["asset2_lookdev"], 'Take1')
    data["asset2_lookdev_take1_version3"] = create_version(data["asset2_lookdev"], 'Take1')
