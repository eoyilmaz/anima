...
from anima.dcc.maya.repr_tools import RepresentationGenerator, Representation
...
def test_generating_all_representations_through_environment_layout_scene(
    ...
    """generating all representations of all references from the
...
def test_generate_gpu_will_end_up_with_an_empty_scene(
    ...
    """generate_gpu will end up with an empty scene"""
    data = create_test_data
    pm = create_pymel
...
def test_generate_gpu_will_overwrite_previous_gpu_version(
    ...
    """generate_gpu will overwrite to the previous GPU version"""
    data = create_test_data
...
def test_generate_gpu_scene_with_references_before_generating_gpu_of_references_first(
    ...
    """a RuntimeError will be raised when trying to generate
...
def test_generate_gpu_of_a_simple_model(
    ...
    """generate_gpu will generate bounding boxes for each
...
def test_generate_gpu_of_a_simple_look_dev(
    ...
    """generate_gpu will just replace the references for a
...
def test_generate_gpu_of_a_layout_of_a_building(
    ...
    """generate_gpu of the layout scene of a building is
    working properly
    """
    data = create_test_data
    pm = create_pymel
...
def test_generate_gpu_of_a_look_dev_of_a_building(
    ...
    """generate_gpu of the look dev scene of a building is
    working properly
    """
    data = create_test_data
    pm = create_pymel
...
def test_generate_gpu_of_a_layout_of_an_environment(
    ...
    """generate_gpu of the layout scene of an environment is
    working properly
    """
    data = create_test_data
    pm = create_pymel
...
def test_generate_gpu_of_a_look_dev_of_an_environment(
    ...
    """generate_gpu of the look dev scene of an environment is
    working properly
    """
    data = create_test_data
    pm = create_pymel
...
def test_generate_gpu_of_a_vegetation_scene(
    ...
    """generate_gpu of the vegetation scene is working properly"""
    data = create_test_data
    pm = create_pymel
    maya_dcc = create_maya_dcc
...
def test_generate_ass_will_end_up_with_an_empty_scene(
    ...
    """generate_ass will end up with a new empty scene"""
    data = create_test_data
    pm = create_pymel
    gen = RepresentationGenerator(version=data["building1_yapi_model_main_v003"])
    gen.generate_ass()
...
def test_generate_ass_will_overwrite_previous_ass_version(
    ...
    """generate_ass will overwrite to the previous ASS version"""
    data = create_test_data
    gen = RepresentationGenerator()
...
def test_generate_ass_repr_for_building_yapi_look_dev_without_creating_model_first(
    ...
    """a RuntimeError will be raised when trying to generate the ASS Repr for
...
def test_generate_ass_repr_for_building_yapi_model(
    ...
    """creating ASS repr for a model is working properly"""
    data = create_test_data
    pm = create_pymel
    maya_dcc = create_maya_dcc
...
def test_generate_ass_repr_for_building_yapi_look_dev_is_working_properly(
    ...
    """ASS repr generation is working properly for a look dev
    version
    """
    data = create_test_data
    pm = create_pymel
...
def test_generate_ass_repr_for_building_layout_is_working_properly(
    ...
    """a generating the ASS Repr for a Layout task is working
    properly
    """
    data = create_test_data
    pm = create_pymel
...
def test_generate_ass_repr_for_building_look_dev_is_working_properly(
    ...
    """generate_ass() will properly generate an ASS repr for the
...
def test_generate_ass_repr_for_vegetation_scene(
    ...
    """generating ass of a vegetation scene is working properly"""
    data = create_test_data
    pm = create_pymel
    maya_dcc = create_maya_dcc
    gen = RepresentationGenerator(version=data["ext1_vegetation_main_v003"])
...
def test_generate_all_will_end_up_with_an_empty_scene(
    ...
    """generate_all will end up with an empty scene"""
    data = create_test_data
    pm = create_pymel
    gen = RepresentationGenerator(version=data["building1_yapi_model_main_v003"])
    gen.generate_all()
...
def test_generate_all_of_a_simple_model(
    ...
    """generate_all will generate all representations of a model
    scene
    """
    data = create_test_data
    gen = RepresentationGenerator(version=data["building1_yapi_model_main_v003"])
...
def test_generate_all_of_a_simple_look_dev(
    ...
    """generate_all generate all the representations of a
    simple look dev scene
    """
    data = create_test_data
    # start with building | props | yapi | model | hires
...
def test_generate_all_of_a_layout_of_a_building(
    ...
    """generate_all the layout scene of a building is working
    properly
    """
    data = create_test_data
    # start with building | props | yapi | model | hires
...
def test_generate_all_of_a_look_dev_of_a_building(
    ...
    """generate_all the look dev scene of a building is
    working properly
    """
    data = create_test_data
    # start with building | props | yapi | model | hires
...
def test_generate_all_of_a_layout_of_an_environment(
    ...
    """generate_all the layout scene of an environment is
    working properly
    """
    data = create_test_data
    gen = RepresentationGenerator()
...
def test_generate_all_of_a_look_dev_of_an_environment(
    ...
    """generate_all the look dev scene of an environment is
    working properly
    """
    data = create_test_data
    # Building1
...
def test_generate_all_of_a_vegetation_scene(
    ...
    """generate_all the vegetation scene is working properly"""
    data = create_test_data
    gen = RepresentationGenerator(version=data["ext1_vegetation_main_v003"])
    gen.generate_all()
