...
class ExternalDCCTestCase(unittest.TestCase):
    """tests ExternalDCC class
    """
    ...
    def setUp(self):
        ...
        self.external_env = ExternalDCC(**self.kwargs)
    ...
    def test_name_argument_cannot_be_skipped(self):
        ...
        self.assertRaises(TypeError, ExternalDCC, **self.kwargs)
    ...
    def test_name_argument_is_working_properly(self):
        ...
        external_env = ExternalDCC(**self.kwargs)
...
class ExternalEnvFactoryTestCase(unittest.TestCase):
    """tests ExternalDCCFactory class
    """
    ...
    def test_get_env_method_will_return_desired_environment(self):
        ...
        #self.assertIsInstance(photoshop, ExternalDCC)
        ...
        self.assertTrue(isinstance(zbrush_tool, ExternalDCC))
        ...
        self.assertTrue(isinstance(mudbox, ExternalDCC))
    ...
    def test_get_env_method_will_return_desired_environment_even_with_complex_formats(self):
        ...
        zbrush = ext_env_factory.get_env('ZBrush (.ztl)',
                                         name_format='%n (%e)')
        self.assertTrue(isinstance(zbrush, ExternalDCC))
