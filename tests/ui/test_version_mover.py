...
class VersionMoverTestCase(unittest.TestCase):
    ...
    def create_version(self, task, variant_name: str):
        ...
        Returns:
            Version: The newly created Version instance.
        """
        # get the variant
        variant = (
        ...
        # create a file
        os.makedirs(os.path.dirname(v.absolute_full_path), exist_ok=True)
    ...
    def setUp(self):
        ...
        self.test_structure = Structure(
            name="Test Project Structure", templates=[self.test_task_template]
        )
        ...
        self.test_project_status_list = StatusList.query.filter(
        ...
        # Task4
        # Main
        self.test_version1 = self.create_version(
            self.test_task4,
            variant_name="Main",
        )
        self.test_version2 = self.create_version(
            self.test_task4,
            variant_name="Main",
        )
        self.test_version3 = self.create_version(self.test_task4, variant_name="Main")

        # Variant1
        self.test_version4 = self.create_version(
            self.test_task4, variant_name="Variant1"
        )
        self.test_version5 = self.create_version(
            self.test_task4, variant_name="Variant1"
        )
        self.test_version6 = self.create_version(
            self.test_task4, variant_name="Variant1"
        )

        # Variant2
        self.test_version7 = self.create_version(
            self.test_task4, variant_name="Variant2"
        )
        self.test_version8 = self.create_version(
            self.test_task4, variant_name="Variant2"
        )
        self.test_version9 = self.create_version(
            self.test_task4, variant_name="Variant2"
        )

        # Task5
        # Main
        self.test_version10 = self.create_version(self.test_task5, variant_name="Main")
        self.test_version11 = self.create_version(self.test_task5, variant_name="Main")
        ...
        # Task6
        # Main
        self.test_version19 = self.create_version(self.test_task6, variant_name="Main")
        self.test_version20 = self.create_version(self.test_task6, variant_name="Main")
        ...
        # Task7
        # Main
        self.test_version28 = self.create_version(self.test_task7, variant_name="Main")
        self.test_version29 = self.create_version(self.test_task7, variant_name="Main")
        ...
        # Main
        self.test_version37 = self.create_version(self.test_task9, variant_name="Main")
        self.test_version38 = self.create_version(self.test_task9, variant_name="Main")
    ...
    def test_copy_button_clicked_with_no_selection_on_from_task_tree_view(self):
        ...
        self.assertEqual(
            PatchedMessageBox.message, "Please select a task from <b>From Task</b> list"
        )
    ...
    def test_copy_button_clicked_with_no_selection_on_to_task_tree_view(self):
        ...
        selection_model.select(task4_item.index(), QtGui.QItemSelectionModel.Select)
        ...
        self.assertEqual(PatchedMessageBox.title, "Error")
        self.assertEqual(
            PatchedMessageBox.message, "Please select a task from <b>To Task</b> list"
        )
    ...
    def test_copy_button_is_working_properly(self):
        ...
        selection_model.select(task8_item.index(), QtGui.QItemSelectionModel.Select)
