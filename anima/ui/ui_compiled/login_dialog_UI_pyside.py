...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(
            0, QtGui.QFormLayout.LabelRole, self.login_or_email_label
        )
        ...
        self.formLayout.setWidget(
            0, QtGui.QFormLayout.FieldRole, self.login_or_email_lineEdit
        )
        ...
        self.formLayout.setWidget(
            1, QtGui.QFormLayout.FieldRole, self.password_lineEdit
        )
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(
            QtGui.QApplication.translate(
                "Dialog", "Login to Stalker", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        self.login_or_email_label.setText(
            QtGui.QApplication.translate(
                "Dialog", "Login or email", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        self.password_label.setText(
            QtGui.QApplication.translate(
                "Dialog", "Password", None, QtGui.QApplication.UnicodeUTF8
            )
        )
