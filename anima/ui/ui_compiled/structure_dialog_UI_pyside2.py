...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setLayout(
            0, QtWidgets.QFormLayout.FieldRole, self.name_fields_verticalLayout
        )
        ...
        self.formLayout.setWidget(
            1, QtWidgets.QFormLayout.LabelRole, self.filenmate_templates_label
        )
        ...
        self.formLayout.setWidget(
            2, QtWidgets.QFormLayout.FieldRole, self.custom_template_plainTextEdit
        )
    ...
    def retranslateUi(self, Dialog):
        ...
        self.dialog_label.setText(
            QtWidgets.QApplication.translate("Dialog", "Create Structure", None, -1)
        )
        self.name_label.setText(
            QtWidgets.QApplication.translate("Dialog", "Name", None, -1)
        )
        self.name_validator_label.setText(
            QtWidgets.QApplication.translate("Dialog", "Validator Message", None, -1)
        )
