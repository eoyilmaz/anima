...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.name_fields_verticalLayout.setObjectName(
            _fromUtf8("name_fields_verticalLayout")
        )
        ...
        self.filenmate_templates_label.setObjectName(
            _fromUtf8("filenmate_templates_label")
        )
        ...
        self.filename_template_fields_verticalLayout.setObjectName(
            _fromUtf8("filename_template_fields_verticalLayout")
        )
        self.formLayout.setLayout(
        ...
        self.custom_template_plainTextEdit.setObjectName(
            _fromUtf8("custom_template_plainTextEdit")
        )
        self.formLayout.setWidget(
