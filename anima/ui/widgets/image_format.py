...
class ImageFormatWidget(object):
    ...
    def __init__(
        self, parent=None, parent_form_layout=None, parent_form_layout_index=None
    ):
        self.parent = parent
    ...
    def _setup_ui(self):
        ...
        self.parent_form_layout.setWidget(
            self.parent_form_layout_index, QtWidgets.QFormLayout.LabelRole, self.label
        )
    ...
    def fill_combo_box(self):
        ...
        all_image_formats = (
            DBSession.query(
                ImageFormat.id, ImageFormat.name, ImageFormat.width, ImageFormat.height
            )
