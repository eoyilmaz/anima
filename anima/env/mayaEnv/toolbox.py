    ...
    with main_tabLayout:
        ...
        with general_column_layout:
            ...
            pm.button(
                ...
                c=RepeatedCallback(General.rsproxy_data_importer),
    ...
    def rsproxy_data_importer(cls):
        ...
        class DataManager(object):
            ...
            def load(self, path):
                ...
                for i in range(len(data['instancefile'])):
                    data_obj = DataObject()
        ...
        class DataObject(object):
            ...
            def create(self):
                ...
                self.rs_proxy_node.fileName.set(self.instancefile)
