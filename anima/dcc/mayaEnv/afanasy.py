        ...
        with pm.columnLayout(adj=True):
            ...
            with pm.rowLayout(
                ...
                pm.button(
                    ...
                    c=functools.partial(
                        ...
                        functools.partial(pm.playbackOptions, q=True, min=True),
                    ),
                )
                pm.button(
                    l="<<",
                    ...
                    c=functools.partial(
                        self.set_field_value,
                        start_time_int_field,
                        functools.partial(pm.playbackOptions, q=True, ast=True),
                    ),
                )
            ...
            with pm.rowLayout(nc=4, adj=2, cw4=(labels_width, 40, 15, 15)):
                ...
                pm.button(
                    ...
                    c=functools.partial(
                        self.set_field_value,
                        end_time_int_field,
                        functools.partial(pm.playbackOptions, q=True, max=True),
                    ),
                )
                pm.button(
                    l="<<",
                    ...
                    c=functools.partial(
                        self.set_field_value,
                        end_time_int_field,
                        functools.partial(pm.playbackOptions, q=True, aet=True),
                    ),
                )
            ...
            with pm.rowLayout(nc=2, adj=2, cw2=(labels_width, 50)):
                ...
                pm.intField(
                    ...
                    v=pm.optionVar.get("cgru_afanasy__errors_avoid_host_ov", 3),
                    min=0,
                    max=127,
                )
            ...
            with pm.rowLayout(nc=2, adj=2, cw2=(labels_width, 50)):
                ...
                pm.intField(
                    ...
                    v=pm.optionVar.get("cgru_afanasy__errors_retries_ov", 3),
                    min=0,
                    max=127,
                )
            ...
            with pm.rowLayout(nc=2, adj=2, cw2=(labels_width, 50)):
                ...
                pm.intField(
                    ...
                    v=pm.optionVar.get("cgru_afanasy__errors_task_same_host_ov", 3),
                    min=0,
                    max=127,
                )
            ...
            with pm.rowLayout(nc=2, adj=2, cw2=(labels_width, 50)):
                ...
                pm.intField(
                    ...
                    ann="in seconds",
                    v=pm.optionVar.get(
                        "cgru_afanasy__errors_errors_forgive_time_ov", 18000
                    ),
                    min=0,
                )
            ...
            with pm.rowLayout(
                nc=2, adj=2, cl2=("right", "left"), cw2=(labels_width, 50)
            ):
...
This system will be updated in Afanasy."""
                ...
                pm.intField(
                    ...
                    ann=ann,
                    v=pm.optionVar.get("cgru_afanasy__submit_multiple_times_ov", 1),
                )

            with pm.rowLayout(
                nc=2, adj=2, cl2=("right", "left"), cw2=(labels_width, 40)
            ):
    ...
    def launch(self, *args, **kwargs):
        ...
        try:
            ...
            renderable_cameras = [
                node for node in pm.ls(type="camera") if node.getAttr("renderable")
            ]
        ...
        if render_engine == "redshift":
            ...
            if rs_domes:
                for rs_dome in rs_domes:
                    if (
                        rs_dome.getAttr("background_enable") == 1
            ...
            for directional_light in all_directional_lights:
                if (
                    directional_light.aiAngle.get() == 0
                    and directional_light.attr(dir_sample_attr_name).get() > 1
                ):
        ...
        frames_per_task = pm.intField("cgru_afanasy__frames_per_task", q=1, v=1)
        by_frame = pm.intField("cgru_afanasy__by_frame", q=1, v=1)
        depend_mask_global = pm.textField(
            "cgru_afanasy__depend_mask_global", q=1, text=True
        )
        ...
        separate_layers = pm.radioButtonGrp("cgru_afanasy__separate_layers", q=1, sl=1)
        ...
        pm.optionVar["cgru_afanasy__depend_mask_global_ov"] = depend_mask_global
        ...
        outputs = pm.renderSettings(
            fullPath=1,
            firstImageName=1,
            lastImageName=1,
            leaveUnmatchedTokens=1,
            customTokenString="RenderPass=Beauty",
        )
        ...
        if separate_layers in [2, 3]:
            ...
            layers = [
                layer
                for layer in rlm.connections(type=pm.nt.RenderLayer)
            ...
            for layer in layers:
                ...
                block = af.Block(
                    layer_name, renderer_to_block_type.get(render_engine, "maya")
                )
            ...
            block = af.Block(
                "All Layers", renderer_to_block_type.get(render_engine, "maya")
            )
