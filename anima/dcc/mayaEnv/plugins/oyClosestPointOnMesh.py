...
class oyClosestPointOnMesh(OpenMayaMPx.MPxNode):
    ...
    def compute(self, plug, dataBlock):
        if (
            plug == oyClosestPointOnMesh.aOutPosition
            or plug == oyClosestPointOnMesh.aOutPositionX
            or plug == oyClosestPointOnMesh.aOutPositionY
            or plug == oyClosestPointOnMesh.aOutPositionZ
            or plug == oyClosestPointOnMesh.aOutNormal
            or plug == oyClosestPointOnMesh.aOutNormalX
            or plug == oyClosestPointOnMesh.aOutNormalY
            or plug == oyClosestPointOnMesh.aOutNormalZ
            or plug == oyClosestPointOnMesh.aOutUV
            or plug == oyClosestPointOnMesh.aOutU
            or plug == oyClosestPointOnMesh.aOutV
        ):
            ...
            inPosition = OpenMaya.MPoint(
                inPositionAsFloat3[0], inPositionAsFloat3[1], inPositionAsFloat3[2]
            )
            ...
            meshFn.getClosestPointAndNormal(
                inPosition, outPosition, outNormal, OpenMaya.MSpace.kWorld
            )
...
def nodeInitializer():
    ...
    # input mesh
    oyClosestPointOnMesh.aInMesh = tAttr.create("inMesh", "in", OpenMaya.MFnData.kMesh)
    tAttr.setStorable(0)
    oyClosestPointOnMesh.addAttribute(oyClosestPointOnMesh.aInMesh)

    # input position
    oyClosestPointOnMesh.aInPositionX = nAttr.create(
    ...
    oyClosestPointOnMesh.aInPositionY = nAttr.create(
    ...
    oyClosestPointOnMesh.aInPositionZ = nAttr.create(
    ...
    oyClosestPointOnMesh.aInPosition = nAttr.create(
        "inPosition",
        "ip",
    ...
    # output position
    oyClosestPointOnMesh.aOutPositionX = nAttr.create(
    ...
    oyClosestPointOnMesh.aOutPositionY = nAttr.create(
    ...
    oyClosestPointOnMesh.aOutPositionZ = nAttr.create(
    ...
    oyClosestPointOnMesh.aOutPosition = nAttr.create(
        "outPosition",
        "op",
    ...
    # output normal
    oyClosestPointOnMesh.aOutNormalX = nAttr.create(
    ...
    oyClosestPointOnMesh.aOutNormalY = nAttr.create(
    ...
    oyClosestPointOnMesh.aOutNormalZ = nAttr.create(
    ...
    oyClosestPointOnMesh.aOutNormal = nAttr.create(
        "outNormal",
        "on",
    ...
    # output uv
    oyClosestPointOnMesh.aOutU = nAttr.create(
        "outU", "ou", OpenMaya.MFnNumericData.kFloat, 0.0
    )
    nAttr.setStorable(0)
    nAttr.setWritable(0)
    oyClosestPointOnMesh.addAttribute(oyClosestPointOnMesh.aOutU)

    oyClosestPointOnMesh.aOutV = nAttr.create(
        "outV", "ov", OpenMaya.MFnNumericData.kFloat, 0.0
    )
    nAttr.setStorable(0)
    nAttr.setWritable(0)
    oyClosestPointOnMesh.addAttribute(oyClosestPointOnMesh.aOutV)

    oyClosestPointOnMesh.aOutUV = nAttr.create(
        "outUV", "ouv", oyClosestPointOnMesh.aOutU, oyClosestPointOnMesh.aOutV
    )
    nAttr.setStorable(0)
    nAttr.setKeyable(0)
    nAttr.setWritable(1)
    ...
    # dependencies
    oyClosestPointOnMesh.attributeAffects(
        oyClosestPointOnMesh.aInMesh, oyClosestPointOnMesh.aOutPosition
    )
    oyClosestPointOnMesh.attributeAffects(
        oyClosestPointOnMesh.aInPosition, oyClosestPointOnMesh.aOutPosition
    )

    oyClosestPointOnMesh.attributeAffects(
        oyClosestPointOnMesh.aInMesh, oyClosestPointOnMesh.aOutNormal
    )
    oyClosestPointOnMesh.attributeAffects(
        oyClosestPointOnMesh.aInPosition, oyClosestPointOnMesh.aOutNormal
    )

    oyClosestPointOnMesh.attributeAffects(
        oyClosestPointOnMesh.aInMesh, oyClosestPointOnMesh.aOutUV
    )
    oyClosestPointOnMesh.attributeAffects(
        oyClosestPointOnMesh.aInPosition, oyClosestPointOnMesh.aOutUV
    )
